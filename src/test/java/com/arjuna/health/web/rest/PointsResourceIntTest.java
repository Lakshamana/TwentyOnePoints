...
import com.arjuna.health.TwentyOnePointsApp;

import com.arjuna.health.domain.Points;
import com.arjuna.health.repository.PointsRepository;
import com.arjuna.health.repository.UserRepository;
import com.arjuna.health.repository.search.PointsSearchRepository;
import com.arjuna.health.web.rest.errors.ExceptionTranslator;
...
import static com.arjuna.health.web.rest.TestUtil.createFormattingConversionService;
...
public class PointsResourceIntTest {
    ...
    /**
     * This repository is mocked in the com.arjuna.health.repository.search test package.
     *
     * @see com.arjuna.health.repository.search.PointsSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createPoints() throws Exception {
        ...
        assertThat(testPoints.isMeals()).isEqualTo(DEFAULT_MEALS);
        assertThat(testPoints.isAlcohol()).isEqualTo(DEFAULT_ALCOHOL);
    ...
    public void updatePoints() throws Exception {
        ...
        assertThat(testPoints.isMeals()).isEqualTo(UPDATED_MEALS);
        assertThat(testPoints.isAlcohol()).isEqualTo(UPDATED_ALCOHOL);
