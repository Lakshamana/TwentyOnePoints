...
import com.arjuna.health.domain.Weight;
import com.arjuna.health.repository.WeightRepository;
import com.arjuna.health.repository.search.WeightSearchRepository;
...
public class WeightResourceIntTest {
     ...
     *
     * @see com.arjuna.health.repository.search.WeightSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void searchWeight() throws Exception {
        // Initialize the database
        weightRepository.saveAndFlush(weight);
        when(mockWeightSearchRepository.search(queryStringQuery("id:" + weight.getId())))
            .thenReturn(Collections.singletonList(weight));
        // Search the weight
