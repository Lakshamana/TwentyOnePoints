...
public class BloodPressureResourceIntTest {
     ...
     *
     * @see com.arjuna.health.repository.search.BloodPressureSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void searchBloodPressure() throws Exception {
        // Initialize the database
        bloodPressureRepository.saveAndFlush(bloodPressure);
        when(mockBloodPressureSearchRepository.search(queryStringQuery("id:" + bloodPressure.getId())))
            .thenReturn(Collections.singletonList(bloodPressure));
