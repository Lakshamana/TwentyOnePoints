...
import com.arjuna.health.repository.PreferencesRepository;
import com.arjuna.health.repository.search.PreferencesSearchRepository;
...
import com.arjuna.health.domain.enumeration.WeightUnits;
/**
...
public class PreferencesResourceIntTest {
    ...
    private static final WeightUnits UPDATED_WEIGHT_UNITS = WeightUnits.LB;
     ...
     *
     * @see com.arjuna.health.repository.search.PreferencesSearchRepositoryMockConfiguration
     */
    @Autowired
